...
const age: number = 15; // Change this value to the person's age
...
/*Make sure to replace the age value with the actual age of the person you want to evaluate.
 This script will print out the appropriate message based on the person's age*/